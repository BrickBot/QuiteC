...
___subsf3:
    ...
    ; Among other things, r2l and sp+3 now contain second operand sign

    ; Negate second operand sign

    xor.b   #0x80,r2l           ; negate sign in r2l
    mov.b   r2l,@(3,r7)         ; update copy on stack
